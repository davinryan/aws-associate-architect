...
* align operational and development value streams
...
* Guide: 
  ...
  3. assign development value stream across steps and systems that make sense 
...
* must map ARTS to individual solutions - do a diagram with coloured boxes :) 
  * e.g. ART1 = fleet solutions, ART2 = fullfillment and logistics, ART3 = Vehicle supplier
